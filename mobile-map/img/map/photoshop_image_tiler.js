...
var HighestZoomLevel = 5; // Enter the highest zoom level we are creating tiles for (should be less than OrgZoom; technically the  script should be able to handle values larger as well, but your image quality will suffer)
...
var FolderPath = "~/Desktop/pngbatch/";  //<-- path to where we will save our tiles
...
var OrgZoomLevel = 5;   // the Google Maps zoom level of your Photoshop document (for best results, you will need to resize your  Photoshop document to match a zoom level as closely as possible before running this script)
